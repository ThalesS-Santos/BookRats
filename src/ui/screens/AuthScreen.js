...
const AuthScreen = () => {
  ...
  const [request, response, promptAsync] = Google.useIdTokenAuthRequest({
    webClientId:
      '938992066464-mka61a63o33ltrr2fobm18qugoq35j7d.apps.googleusercontent.com',
    androidClientId:
      '938992066464-mka61a63o33ltrr2fobm18qugoq35j7d.apps.googleusercontent.com',
    iosClientId:
      '938992066464-mka61a63o33ltrr2fobm18qugoq35j7d.apps.googleusercontent.com',
      ...
      <ScrollView
        ...
        <View className="items-center mb-10">
          <View
            ...
            style={{
              backgroundColor: `${primaryColorHex}20`,
        ...
        <View className="space-y-4">
          <View>
            <Text
              className={`mb-2 ml-1 text-sm font-semibold uppercase tracking-wider ${subTextColor}`}>
              E-mail
            </Text>
            <View
              className={`flex-row items-center rounded-2xl px-4 border ${inputBgColor} ${inputBorderColor}`}>
          ...
          <TouchableOpacity
            ...
            {loading ? (
              ...
              <>
                <Text
                  className={`text-lg font-bold mr-2 ${isDarkMode ? 'text-[#000000]' : 'text-[#FFFFFF]'}`}>
          ...
          <View className="flex-row items-center my-6">
            <View
              className={`flex-1 h-[1px] ${isDarkMode ? 'bg-[#262626]' : 'bg-[#E5E7EB]'}`}
            />
            <Text
              className={`mx-4 text-xs font-bold uppercase tracking-widest ${subTextColor}`}>
              Ou continue com
            </Text>
            <View
              className={`flex-1 h-[1px] ${isDarkMode ? 'bg-[#262626]' : 'bg-[#E5E7EB]'}`}
          ...
          <TouchableOpacity
            ...
            <Text className={`text-lg font-bold ml-3 ${textColor}`}>
              Google
            </Text>
          </TouchableOpacity>
