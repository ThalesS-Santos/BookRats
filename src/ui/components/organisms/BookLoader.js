...
const BookLoader = ({ isVisible = true, bookCover = null }) => {
  ...
  return (
    <Animated.View
      ...
      style={[
        styles.container,
        { opacity: fadeAnim, backgroundColor: BG_COLOR },
      ]}>
      <View style={styles.content}>
          ...
          {bookCover ? (
            ...
            <>
              ...
              <View style={[styles.bookOutline, { borderColor: ACCENT_COLOR }]}>
                ...
                <View
                  style={[
                    styles.pixelPageBlock,
                    styles.leftPage,
                    { borderColor: ACCENT_COLOR },
                  ]}>
                  <View
                    style={[
                      styles.pageInnerLine,
                  ...
                  <View
                    style={[
                      styles.pageInnerLine,
                      { top: 40, backgroundColor: `${ACCENT_COLOR}33` },
                    ]}
                  />
                </View>
                ...
                {/* Central Spine */}
                <View
                  style={[styles.pixelSpine, { backgroundColor: ACCENT_COLOR }]}
                />
              </View>
              ...
              <View style={styles.bookBottom}>
                <View
                  style={[styles.pixelBlock, { borderColor: ACCENT_COLOR }]}
                />
                <View
                  style={[styles.pixelBlock, { borderColor: ACCENT_COLOR }]}
                />
        ...
        <View style={styles.textContainer}>
          <Text style={[styles.tagLine, { color: ACCENT_COLOR }]}>
            SABIA QUE?
          </Text>
          <Text style={[styles.messageText, { color: TEXT_MUTED }]}>
            {curiosity}
          </Text>
        </View>
      </View>
