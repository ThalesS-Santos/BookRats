...
describe('BookService', () => {
  ...
  describe('getRecentAnnotations', () => {
    it('should return empty if uid is missing', async () => {
      expect(
        await BookService.getRecentAnnotations(null, [{ id: 'b1' }]),
      ).toEqual([]);
    });
    ...
    it('should fetch from up to 3 books, sort and limit', async () => {
      ...
      getUserAnnotations
        ...
        .mockResolvedValueOnce([
          { id: 'a3', timestamp: { seconds: 20 } },
          { id: 'a4', timestamp: { seconds: 5 } },
        ]); // b3
    ...
    it('should catch error and return empty array', async () => {
      ...
      const result = await BookService.getRecentAnnotations('u1', [
        { id: 'b1' },
      ]);
