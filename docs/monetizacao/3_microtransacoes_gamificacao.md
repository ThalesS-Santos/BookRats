    ...
    try {
      ...
      if (success) {
        ...
        Alert.alert(
          ...
          'Seu streak de ' +
            userStreak +
            ' dias foi restaurado com sucesso! 🔥',
        );
      }
    } catch (e) {
      Alert.alert(
        'Erro',
        'Não foi possível completar a compra do seu Streak Freeze.',
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <View style={styles.modalContainer}>
      ...
      <Text style={styles.description}>
        Sua sequência de <Text style={styles.highlight}>{userStreak} dias</Text>{' '}
        de leitura diária está prestes a expirar. Use um Streak Freeze para
        salvá-la!
      </Text>
...
- _“Thales, seu streak de 98 dias está prestes a congelar! Abra o livro 'O Alquimista' agora para garantir o seu dia ou use um de seus 2 Streak Freezes acumulados.”_
