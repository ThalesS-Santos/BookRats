...
1. **Cloud Functions de Pagamento**: Criação de funções serverless em Node.js para receber e assinar Webhooks do _RevenueCat_ / _Stripe_ para validações atômicas de status de assinantes.
